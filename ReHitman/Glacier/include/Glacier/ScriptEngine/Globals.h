...
namespace Glacier
{
    ...
    /**
     * Actually, it's
     * typedef map<void*,unsigned int,std::less<void*>,PrivateAllocator<std::pair<const void*, unsigned int>, ISaveMemoryManager> > SaveTableMap;
     */
    struct SaveTableMap;

    /**
     * Actually, it's
     * typedef vector<SaveRefEntry,PrivateAllocator<SaveRefEntry, ISaveMemoryManager> > SaveTableVector;
     */
    struct SaveTableVector;
