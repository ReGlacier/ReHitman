...
namespace Glacier
{
    ...
    struct  ZCmdList
    {
        ...
        {
            CMD_SET_VIEW = 0x0,
            CMD_VIEWPORT_SETUP = 0x1,
            CMD_VIEWPORT_CLEAR = 0x2,
            CMD_LIGHT_SETUP = 0x3,
            CMD_LIGHT_SETUP_2 = 0x4,
            ...
            CMD_SCISSOR_SETUP = 0x10,
            CMD_OBJECT_DRAW = 0x11,
            CMD_APPLY_POSTFILTER = 0x12,
            CMD_MIRROR_BEGIN = 0x13,
            CMD_MIRROR_RENDER_REFLECTORS = 0x14,
            CMD_MIRROR_RENDER_REFLECTED = 0x15,
            CMD_MIRROR_RENDER_ZHOLE = 0x16,
            CMD_MIRROR_END = 0x17,
            CMD_OPTIMIZED_MIRROR_CLEAR_ZBUFFER = 0x18,
            CMD_OPTIMIZED_MIRROR_RENDER_REFLECTORS = 0x19,
            CMD_OPTIMIZED_MIRROR_SET_STENCIL_REF = 0x1A,
            CMD_OPTIMIZED_MIRROR_RENDER_REFLECTED = 0x1B,
            CMD_OPTIMIZED_MIRROR_END = 0x1C,
            CMD_CULL_NORMAL = 0x1D,
            CMD_CULL_REVERSED = 0x1E,
            CMD_PUSH_SURFACE = 0x1F,
            CMD_POP_SURFACE = 0x20,
            CMD_SET_SURFACE = 0x21,
            CMD_COPY_SURFACE = 0x23,
            CMD_FILL_SURFACE = 0x24,
            CMD_SET_COLOR_WRITE_MASK = 0x25,
            CMD_BLUR_SURFACE = 0x27,
            CMD_TEXTURE_PROJECTION_INDEX = 0x28,
            CMD_RENDER_FULLSCREEN_QUAD = 0x29,
            CMD_SET_PROJECTION = 0x2A,
            CMD_PUSH_PROJECTION = 0x2B,
            CMD_POP_PROJECTION = 0x2C,
            CMD_SET_FIRST_PERSON_BONES = 0x2D,
