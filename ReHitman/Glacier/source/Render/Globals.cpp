...
namespace Glacier
{
    ...
    STATIC_GLOBAL_CLASS_INSTANCE_IMPL(ZTextureD3D, g_texMouse16x16, 0x0090AE10, {});
    STATIC_GLOBAL_CLASS_INSTANCE_IMPL(ZTextureD3D, g_texShadowClip1x2, 0x0090AE58, {});
    STATIC_GLOBAL_CLASS_INSTANCE_IMPL(ZTextureD3D, g_texFont8x13, 0x0090AEA0, {});
    STATIC_GLOBAL_CLASS_INSTANCE_IMPL(ZFontLetterPositionTable, g_FontLetterPositions, 0x008EE130, {});
