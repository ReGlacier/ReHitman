#include <Glacier/Render/Prim/ZPrimAccessStandardMeshD3D.h>
...
namespace Glacier
{
    ...
    ZPrimAccessStandardMeshD3D::ZPrimAccessStandardMeshD3D(uint32_t hPrim)
        : ZPrimAccessMesh()
    {
    ...
    ZPrimAccessStandardMeshD3D::~ZPrimAccessStandardMeshD3D()
    {
    ...
    ZPrimAccessMesh* ZPrimAccessStandardMeshD3D::CreateEditable(uint32_t lNumTriangles, uint32_t lNumVertices)
    {
        auto* pResult = static_cast<ZPrimAccessStandardMeshD3D*>(Create(m_hPrim));
        pResult->Allocate(lNumTriangles, lNumVertices);

        return pResult;
    }

    void ZPrimAccessStandardMeshD3D::GetPositions(uint32_t lStartVertex, uint32_t lNumVertices, float* pfPosition)
    {
        ZASSERT(lStartVertex + lNumVertices <= GetNumVertices());

        const auto* pVertices = reinterpret_cast<const SVertexWintelDP3*>(GetVerticesConst());
    ...
    void ZPrimAccessStandardMeshD3D::SetPositions(uint32_t lStartVertex, uint32_t lNumVertices, const float* pfPosition)
    {
        ZASSERT(lStartVertex + lNumVertices <= GetNumVertices());

        auto* pVertices = reinterpret_cast<SVertexWintelDP3*>(const_cast<uint32_t*>(GetVertices()));
        for (uint32_t i = 0; i < lNumVertices; ++i)
        {
    ...
    void ZPrimAccessStandardMeshD3D::GetNormals(uint32_t lStartVertex, uint32_t lNumVertices, float* pfNormal)
    {
        ZASSERT(lStartVertex + lNumVertices <= GetNumVertices());
    ...
    void ZPrimAccessStandardMeshD3D::SetNormals(uint32_t lStartVertex, uint32_t lNumVertices, const float* pfNormal)
    {
        ZASSERT(lStartVertex + lNumVertices <= GetNumVertices());
    ...
    void ZPrimAccessStandardMeshD3D::GetColors(uint32_t lStartVertex, uint32_t lNumVertices, uint32_t* plColors)
    {
        ZASSERT(lStartVertex + lNumVertices <= GetNumVertices());
    ...
    void ZPrimAccessStandardMeshD3D::SetColors(uint32_t lStartVertex, uint32_t lNumVertices, const uint32_t* plColors)
    {
        ZASSERT(lStartVertex + lNumVertices <= GetNumVertices());
    ...
    void ZPrimAccessStandardMeshD3D::GetTexCoords(uint32_t lStartVertex, uint32_t lNumVertices, float* pfTexCoords)
    {
        ZASSERT(lStartVertex + lNumVertices <= GetNumVertices());
    ...
    void ZPrimAccessStandardMeshD3D::SetTexCoords(uint32_t lStartVertex, uint32_t lNumVertices, const float* pfTexCoords)
    {
        ZASSERT(lStartVertex + lNumVertices <= GetNumVertices());
    ...
    void ZPrimAccessStandardMeshD3D::GetVerticesRaw(uint32_t lStartVertex, uint32_t lNumVertices, void* pVertices)
    {
        ZASSERT(lStartVertex + lNumVertices <= GetNumVertices());

        const auto* pSrc = reinterpret_cast<const SVertexWintelDP3*>(GetVerticesConst()) + lStartVertex;
        auto* pDst = reinterpret_cast<SVertexWintelDP3*>(pVertices);
        for (uint32_t i = 0; i < lNumVertices; ++i)
        {
            memcpy(&pDst[i], &pSrc[i], sizeof(SVertexWintelDP3));
        }
    }

    void ZPrimAccessStandardMeshD3D::SetVerticesRaw(uint32_t lStartVertex, uint32_t lNumVertices, const void* pVertices)
    {
        ZASSERT(lStartVertex + lNumVertices <= GetNumVertices());

        const auto* pSrc = reinterpret_cast<const SVertexWintelDP3*>(pVertices) + lStartVertex;
        auto* pDst = reinterpret_cast<SVertexWintelDP3*>(const_cast<uint32_t*>(GetVertices()));
        for (uint32_t i = 0; i < lNumVertices; ++i)
        {
            memcpy(&pDst[i], &pSrc[i], sizeof(SVertexWintelDP3));
        }
    ...
    void ZPrimAccessStandardMeshD3D::GetTriangles(uint32_t lStartTriangle, uint32_t lNumTriangles, float* pfVertices)
    {
    ...
    uint32_t ZPrimAccessStandardMeshD3D::GetTrianglesInBox(uint32_t lStartTriangle, uint32_t iNumTestTriangles, float* pfVertices, uint32_t lMaxNumTriangles, const float* vMin, const float* vMax)
    {
        GetNumVertices();
        GetNumTriangles();
        ...
        {
            const SVertexWintelDP3* pV0 = &pVertices[pTriangles[0]];
            const SVertexWintelDP3* pV1 = &pVertices[pTriangles[1]];
            const SVertexWintelDP3* pV2 = &pVertices[pTriangles[2]];
    ...
    uint32_t ZPrimAccessStandardMeshD3D::GetTrianglesInBox(uint32_t* pTriangles, uint32_t lMaxNumTriangles, const float* vMin, const float* vMax) const
    {
        GetNumVertices();
        ...
        {
            const SVertexWintelDP3* pV0 = &pVertices[pIndices[0]];
            const SVertexWintelDP3* pV1 = &pVertices[pIndices[1]];
            const SVertexWintelDP3* pV2 = &pVertices[pIndices[2]];
    ...
    void ZPrimAccessStandardMeshD3D::Allocate(uint32_t lNumTriangles, uint32_t lNumVertices)
    {
        const SPrimMesh* pSrcMesh = m_hPrim;

        m_pAllocatedVertices = ZUniMemory::NewArray<SVertexWintelDP3>(lNumVertices);
        memset(m_pAllocatedVertices, 0, sizeof(SVertexWintelDP3));
