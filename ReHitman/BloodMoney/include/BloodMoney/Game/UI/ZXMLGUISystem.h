...
namespace Hitman::BloodMoney
{
    ...
    struct ZMenu3DCam
    {
        ...
        // Size: 0xac (172) bytes
        Glacier::ZCAMERA* m_pCamera;
        Glacier::IView* m_pIView;
        Glacier::ZGEOM* m_pGeom;
        Glacier::TIMETYPE m_LastActualTime;
        bool m_bReserved;
        ZEaseIn m_AnimateAngleY;
        ZEaseIn m_AnimateAngleZ;
        ZEaseIn m_AnimateCamPos;
        EState m_eState;
        Glacier::TIMETYPE m_LastJoystickMove;
        Glacier::ZGROUP* m_pReleaseGroup;
        Glacier::ZGEOM* m_pNextGeom;
        float m_fDefaultCamPosX;
        Glacier::ZMat3x3 m_DefaultMat;
    };
    ...
    public:
        ...
        Glacier::ZGROUP* m_pGroupFonts; // +0x38
        ...
        Glacier::ZCAMERA* m_pBackgroundCam; // +0x434
        Glacier::ZCAMERA* m_pMenuCam; // +0x438
        Glacier::ZCAMERA* m_pDialogCam; // +0x43c
        Glacier::ZCAMERA* m_pTRCCam; // +0x440
