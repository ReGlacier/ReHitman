...
namespace Hitman::BloodMoney
{
    ...
    std::intptr_t BMConfigurationService::BMAPI_FunctionAddress_ZHM3Actor_InitMapIcon = BMConfigurationService::kNotConfiguredOption;    
    ...
    std::intptr_t BMConfigurationService::BMAPI_FunctionAddress_ZHM3ItemWeaponCustom_SetSilencerType = BMConfigurationService::kNotConfiguredOption;
    ...
    std::intptr_t BMConfigurationService::BMAPI_FunctionAddress_ZGuardQuarterController_RegisterActor = BMConfigurationService::kNotConfiguredOption;
